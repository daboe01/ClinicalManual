...
\label{chap:auth}
Der Benutzer identifiziert sich nach Eingabe der Programm-URL in den Webbrowser, nach dem Neuladen der Browserseite oder nach Betätigung des Logout-Befehls (Kapitel \ref{chap:mainmenu}) über sein klinikumsweit eindeutiges LDAP-Kürzel (Abbildung \ref{fig:login}), dort password aenderung, Ein level von 3 bedeutet uneingeschränkte Rechte.
Die Benutzerverwaltung und das Rechte\-konzept sind folgendermaßen. Nur die Studien  der zugeordneten Arbeitsgruppen sind für den angemeldeten Benutzer sichtbar. 
...
Hauspreise, GoAE (Abbildung \ref{fig:procedures})
Verweis auf Anhang mit beispielcode. Dauer der prozedur in minuten..

\begin{figure}[htbp]
\begin{center}
\includegraphics[scale=0.4]{figs/procedures.png}
...
Wie kommt man hin, wie trägt man termine ein, wie trägt man teilzeit ein (abwesenheit an einzelnen tagen). Download Visitconflictlist erklaeren. (Abbildung \ref{fig:groupware})
