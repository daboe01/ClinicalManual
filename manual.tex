...
\chapter{Hauptmenü}
Das Hauptmenü nimmt einen Streifen am oberen Ende des Browser-Fensters ein und beinhaltet Befehle, die nicht ausschließlich für einen Teilbereich des Programms anwendbar sind.
\label{chap:mainmenu}
\section{Edit}
...
\section{Special}
Unter dem Menü 'Special' sind der Benutzerkalender (Kapitel \ref{chap:calendar}), der persönliche Bereich (Kapitel \ref{chap:personal}) und der Logout Befehl subsummiert.
