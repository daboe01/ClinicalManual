...
Das Programm soll primär einen barrierefreien Zugriff auf alle zur Durchführung einer klinischen Studie erforderlichen Informationen ermöglichen. Zusätzlich sollen redundante Dateneingaben konsequent vermieden werden (beispielsweise Visitentermine in einen Übersichtskalender, auf Merkblätter, auf Fahrtkostenabrechnungen und auf Sponsorrechnungen, 'don't repeat yourself'). Schlussendlich  soll auch die Quelldatendokumentation erleichtert werden.
...
\caption{Die Benutzeroberfläche unterteilt sich in einen konstanten linken Bereich mit der Studienübersicht und einen variablen rechten Bereich, dessen Inhalt über die Tab-Reiter im Kopfbereich bestimmt wird. Die Breite des linken und rechten Bereiches lässt sich über das Ziehen der Trennlinie mit der Maus jederzeit verändern.}
...
\caption{Konfigurationsfenster für die  selektierte Studie. Hier werden u.a. die Statuswerte der für Studienteilnehmer, die Visitenintervalle und deren Prozeduren mit zugehörigem Personal hinterlegt.}
\label{fig:config}
\end{center}
\end{figure}
